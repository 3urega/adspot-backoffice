...
final class LoginAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    private const LOGIN_USUARIO_ADMINISTRADOR_REDIRECT_URL = 'crear_producto_backoffice';
    private const LOGIN_USUARIOPARTICULAR = 'crear_usuario_particular';
    ...
    public function onAuthenticationSuccess(
        ...
        } elseif ($token->getUser() instanceof SfUsuarioParticular) {
            $route = self::LOGIN_USUARIOPARTICULAR;
        } 
