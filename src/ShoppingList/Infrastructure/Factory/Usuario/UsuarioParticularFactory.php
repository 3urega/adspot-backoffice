 ...
 */
final class UsuarioParticularFactory extends PersistentProxyObjectFactory
{
    ...
    protected function initialize(): static
    {
        ...
        return $this->afterInstantiate(function(UsuarioParticular $usuarioParticular) {});
    }

    public static function class(): string
    {
        return UsuarioParticular::class;
    }
}
