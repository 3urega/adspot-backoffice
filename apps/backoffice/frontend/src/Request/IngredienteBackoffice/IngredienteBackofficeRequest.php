 ...
 */
abstract class IngredienteBackofficeRequest extends FrontendRequest
{
    ...
    public static function fromRequest(Request $request): IngredienteBackofficeRequest
    {
        return new static(
    ...
    public final function validateRequest(): void
    {
        $constraint = new Assert\Collection(
            [
                'nombre'     => [new Assert\NotBlank(), new Assert\Length(['min' => 5, 'max' => 155])],
            ]
        );
